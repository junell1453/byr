...
<node TEXT="定义" POSITION="bottom_or_right" ID="ID_955728828" CREATED="1759462225724" MODIFIED="1759676700566">
<edge COLOR="#007c7c"/>
<node TEXT="\latex   \epsilon-N 语言的定义" POSITION="top_or_left" ID="ID_1984000886" CREATED="1759461912235" MODIFIED="1759462240412">
<node TEXT="\latex 若一个数列$a_n$,对于给定常数a,对于任意 $\epsilon&gt;0$总存在正整数N,&#xa;使得n&gt;N时,$|a_n-a|&lt; \epsilon$ 恒成立,则称a为$a_n$的极限，即$a_n$收敛于a" ID="ID_727964406" CREATED="1759461932063" MODIFIED="1759732431858"/>
</node>
<node TEXT="基于邻域的定义" POSITION="top_or_left" ID="ID_1507926549" CREATED="1759461958510" MODIFIED="1759680957907">
<node TEXT="\latex 邻域$U(x_0,\epsilon)$" ID="ID_1025532011" CREATED="1759676966304" MODIFIED="1759680918834">
...
<node TEXT="判别收敛" POSITION="top_or_left" ID="ID_1278419225" CREATED="1759462185541" MODIFIED="1759715752076">
<edge COLOR="#7c007c"/>
<node TEXT="单调有界准则" ID="ID_1393350020" CREATED="1759398936765" MODIFIED="1759398994890">
<node TEXT="单调有界必收敛" ID="ID_1165577248" CREATED="1759477569851" MODIFIED="1759717192961"><richcontent TYPE="DETAILS">
<html>
  <head>
...
<node TEXT="数列归并原理" ID="ID_1194820691" CREATED="1759398944973" MODIFIED="1759399026156">
<node TEXT="\latex $\lim\limits_{n\to\infty}{a_n}=a \Leftrightarrow a_n$的所有子列收敛于a" ID="ID_1347225144" CREATED="1759717490337" MODIFIED="1759717593200">
...
<node TEXT="Weierstrass定理" ID="ID_53312633" CREATED="1759398965936" MODIFIED="1759719370328">
<node TEXT="闭区间套定理" ID="ID_1826415685" CREATED="1759399045339" MODIFIED="1759497798304">
...
<node TEXT="一个数列收敛的充要条件是它是基本数列" ID="ID_1946315408" CREATED="1759719469615" MODIFIED="1759719470552">
<node TEXT="充分性" POSITION="bottom_or_right" ID="ID_1429997387" CREATED="1759719652287" MODIFIED="1759719668418">
...
<node TEXT="必要性" POSITION="bottom_or_right" ID="ID_909331921" CREATED="1759719974754" MODIFIED="1759719980687">
...
<node TEXT="\latex 已知$a_n$有界,则其必存在收敛子列$a_{n_k}$;\\&#xa;设$a_{n_k}$收敛于a,则$\epsilon&gt;0,\exists K \in N_+$,使得当$k&gt;K$时,$|a_{n_k}-a|&lt;\frac{\epsilon}{2}$\\&#xa;且$a_n$是基本数列,设$N_1=Max\{K,N\}$\\&#xa;则当$n&gt;N_1$时,有$|a_n-a|\leq |a_n-a_{n_{N_1+1}}|+ |a_{n_{N_1+1}}-a|&lt;\epsilon$\\&#xa;则$a_n$收敛于a" POSITION="bottom_or_right" ID="ID_928699528" CREATED="1759560732308" MODIFIED="1759732588898"/>
</node>
</node>
</node>
</node>
<node TEXT="性质" POSITION="bottom_or_right" ID="ID_1925293990" CREATED="1759461257964" MODIFIED="1759676705157">
<edge COLOR="#0000ff"/>
<node TEXT="唯一性" POSITION="bottom_or_right" ID="ID_1332960649" CREATED="1759461260469" MODIFIED="1759717487372">
<node TEXT="收敛数列的极限是唯一的" POSITION="top_or_left" ID="ID_676995505" CREATED="1759461827436" MODIFIED="1759717487371">
...
<node TEXT="有界性" ID="ID_1672444025" CREATED="1759461578635" MODIFIED="1759461583413">
<node TEXT="收敛数列是有界的" ID="ID_89143351" CREATED="1759461601880" MODIFIED="1759461609286">
<node TEXT="\latex 设数列$a_n$的极限为$a,\epsilon=1 ,\exists N$,\\&#xa;当$n&gt;N$时,$\forall N有|a_n-a|&lt;\epsilon$\\&#xa;$|a_n|=|a_n+a-a|&lt;|a_n-a|+|a|&lt;1+|a|$\\&#xa;设$Max={a_1,a_2....1+|a|}$,则$|a_n|&lt;Max$,\\&#xa;故$a_n$为有界数列" POSITION="bottom_or_right" ID="ID_1076497898" CREATED="1759461624386" MODIFIED="1759732445785"/>
</node>
</node>
<node TEXT="保号性" ID="ID_1358090921" CREATED="1759462552900" MODIFIED="1759673649304">
<node TEXT="\latex 存在N,使得n&gt;N时,$a_n$与$a$同号,且$a_n \geq \frac {a}{2}$" ID="ID_1840669837" CREATED="1759462618211" MODIFIED="1759716119688">
...
<node TEXT="保序性" ID="ID_336582589" CREATED="1759462592209" MODIFIED="1759673741294">
<node TEXT="\latex $\exists N \in N_+ 使得 \forall n&gt;N,a_n \leq b_n则a \leq b$" ID="ID_1766012011" CREATED="1759680358373" MODIFIED="1759715919974">
...
<node TEXT="有理运算法则" ID="ID_283460880" CREATED="1759461467230" MODIFIED="1759679750311">
<node TEXT="\latex $\lim\limits_{n\to\infty}{(a_n+b_n)}=a+b$" POSITION="bottom_or_right" ID="ID_929554337" CREATED="1759679427035" MODIFIED="1759681614811"><richcontent TYPE="DETAILS">
<html>
  <head>
...
<node TEXT="\latex $\lim\limits_{n\to\infty}(a_nb_n)=ab$" POSITION="bottom_or_right" ID="ID_485155049" CREATED="1759680566389" MODIFIED="1759680701110">
...
<node TEXT="\latex $\lim\limits_{n\to\infty}(\frac{a_n}{b_n})=\frac{a}{b}$" POSITION="bottom_or_right" ID="ID_646229687" CREATED="1759716188016" MODIFIED="1759716395098">
...
<node TEXT="夹逼性" POSITION="bottom_or_right" ID="ID_1206390047" CREATED="1759461694555" MODIFIED="1759717918472">
<node TEXT="\latex $ a_n \leq  c_n\leq b_n 则\lim\limits_{n\to\infty}{c_n}=a$" ID="ID_660979913" CREATED="1759470842171" MODIFIED="1759716711568">
...
<node TEXT="补充" POSITION="top_or_left" ID="ID_1090495667" CREATED="1759462089275" MODIFIED="1759676721368">
<edge COLOR="#7c0000"/>
<node TEXT="归并的简化" ID="ID_128457516" CREATED="1759462100097" MODIFIED="1759462101340">
<node TEXT="\latex $a_n$收敛的充要条件是它的奇数项和偶数项组成的\\子列收敛于同一个常数a" ID="ID_1209886095" CREATED="1759565024250" MODIFIED="1759721930895">
<node TEXT="充分性" POSITION="bottom_or_right" ID="ID_774044247" CREATED="1759565144706" MODIFIED="1759720733681">
<node TEXT="由归并原理显然可证" ID="ID_1330167186" CREATED="1759720735522" MODIFIED="1759720737033"/>
</node>
<node TEXT="必要性" POSITION="bottom_or_right" ID="ID_380410152" CREATED="1759720741355" MODIFIED="1759720745501">
...
<node TEXT="无穷大(小)量" ID="ID_721869579" CREATED="1759462105420" MODIFIED="1759722295442">
<node TEXT="\latex 设$a_n$对于任意$m&gt;0$都存在$N&gt;0$,使得当$n&gt;N$时,若" POSITION="bottom_or_right" ID="ID_1668420710" CREATED="1759566214411" MODIFIED="1759722340172">
...
<node TEXT="e的定义" ID="ID_484864480" CREATED="1759462117469" MODIFIED="1759722376048">
